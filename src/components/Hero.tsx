    ...
    <header className='relative min-h-screen'>
        ...
        <article className='absolute bottom-0 mb-64 px-8'>
            ...
            <p className='text-base'>Nota 
                <span  className={`inline-block mx-2 py-2 px-3 border-4 bg-black bg-opacity-75 
                        rounded-full ${getBorderColor()}`}>
                    {score}
                </span>
            </p>
            <button className='text-base py-2 px-8 mr-2 mt-8 rounded bg-black bg-opacity-50 
